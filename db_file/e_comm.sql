...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 16, 2022 at 07:05 AM
...
(2, '2022_08_11_064734_create_users_table', 1),
(3, '2022_08_11_081331_create_product_table', 2),
(4, '2022_08_11_092640_create_cart_table', 3),
(5, '2022_08_12_095740_create_orders_table', 4);
...
(1, 2, 1, 'pending', 'cash', 'pending', 'kharadi ,pune', NULL, NULL),
(2, 1, 3, 'pending', 'cash', 'pending', 'USA', NULL, NULL),
(3, 2, 3, 'pending', 'cash', 'pending', 'USA', NULL, NULL);
...
(1, 'LG Mobile', '200', 'mobile', 'A SmartPhone with 4gb ram and much more features', 'https://assets.mspimages.in/c/tr:w-375,h-300,c-at_max/5836-284-1.jpg', NULL, NULL),
...
(1, 'atik tambakwale', 'admin@gmail.com', '$2y$10$chqRCeDmWE8PafLpHFNG9.vEuAhUReJb/jTDrd68O2yz/2OUNOWju', NULL, NULL),
(2, 'Peter Parker', 'Peter@gmail.com', '$2y$10$uzDWYdg9X2nkUXOQ1n9A6OPWDXbJVgofMrN7awyk.XeRYY1akWBo2', NULL, NULL),
(3, 'demo user', 'demo@user.com', '$2y$10$un0UmkQFkKby7ZJPwwBlo.Cslv.bGrekuIAzvz/E.NQu2XMsjBGf6', '2022-08-12 05:42:55', '2022-08-12 05:42:55');
